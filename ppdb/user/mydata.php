    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><label style="font-size:50px; font-family:Georgia;">SD Ceria</label></a>
            </div>
            <div class="main-menu">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    Selamat Datang di Sistem Informasi Penerimaan Peserta Didik Baru (PPDB) SD Ceria.
                                         <br><br>
                                         Panduan Pendaftaran:
                                         <br>1. Isi Seluruh Formulir Yang Ditampilkan Kemudian Periksa Kembali, Pastikan Tidak Ada Data Yang Salah.
                                         <br>2. Klik Simpan, Kemudian Klik Konfirmasi. Setelah di-Konfirmasi, Data Tidak Dapat Diubah Kembali.
                                         <br>3. Jika Sudah, Bukti Pendaftaran Akan Ditampilkan dan Dapat Diunduh.
                                         <br>
                                         <br>*Note: Pihak Sekolah Baru Akan Menerima Data Anda Setelah Anda Klik 'Konfirmasi'
                                    </div>
                                </div>
                            </div>
                        </div>
