...
.btn{
  ...
  <label style="font-size:50px; font-family:Arial; font-weight:bold;">Login PPDB SD Ceria</label><br>
  <label style="font-size:25px; font-family:Georgia;">~ Carolin Indriyani Sitimai ~</label><br>

	<br \><br \>
			<div class="container">
					<div style="color:white">
					<label>Login</label><br \>
					<label>Email: siswaolin@gmail.id  |  Password : olin</label><br \>
					<label>Email: carolinadmin@gmail.com  |  Password : Carolin12</label>
					</div>
                <form method="post">
